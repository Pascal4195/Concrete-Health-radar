    ...
    >
      ...
      <div style={{ textAlign: 'center', marginBottom: '14px' }}>
        ...
        <div style={{
          ...
          {isLoading
            ? <span style={{ fontSize: '13px', color: 'rgba(200,134,10,0.45)', animation: 'blink 1.2s infinite' }}>FETCHING...</span>
            : vault.hfDisplay
          }
        </div>
      </div>
